...
printResults = "rta_exp_platooning_rss_noerrors_resilience6-" + today + ".txt" 

with open(printResults,'w') as f:
  print("**** Resilience Check ***",file=f)
  maudeLoad = "../logicalScenarios/platooning/scenarios/following_RSS/load-platooning-manh2.maude"
  maudeModule = 'SCENARIO-PLATOONING'
  asys = "asys(36,basicCondReactTimeEqDT(5/1,40/1) and testBounds1(6/1,4/1,1/1,1/2),2)"
  t = 2
  safer = 3
  safe = 2 
  bad = 1
