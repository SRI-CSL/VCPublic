...
printResults = "rta_exp_ped_errors_33_resilience2-" + today + ".txt" 

with open(printResults,'w') as f:
  print("**** Resilience Check ***",file=f)
  maudeLoad = "../logicalScenarios/pedestrian-crossing/scenarios/errorPedS/load-pedestrian-error-pedS.maude"
  maudeModule = 'SCENARIO-CROSSING'
  asys = "asysPedXLineErrorPedS(3,3/1,2/1,1/1,1/10,1/3)"
  t = 5
  safer = 3
  safe = 2 
  bad = 1
